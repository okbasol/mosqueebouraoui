      ...
      <form className="form-pro" onSubmit={handleSubmit} noValidate>
        ...
        <div className="form-pro-grid">
          ...
          <div className="form-pro-group">
            ...
            <input type="text" id="telegram" name="telegram" value={formData.telegram} onChange={e => handleInputChange('telegram', e.target.value)} disabled={isSubmitting} placeholder="أدخل معرف Telegram" />
          </div>
        </div>
        {/* Commitment Checkbox */}
